...
module.exports = {
    ...
    obterPaymentId: async (amnt,usr,nmbr) => {  
        const url = 'https://webservice.livepix.gg/profile/obigleo/tip';
        const headers = {
          'Content-Type': 'application/json',
          'Cookie': '_ga=GA1.1.837469950.1681344574; visitorId=82aa0833-7f8f-4571-9cdf-421369963e62; _ga_DC3GM8RENN=GS1.1.1681344573.1.1.1681346414.0.0.0',
      ...
      obterTransactionSucess: async(msg)=>{
        const url = 'https://webservice.livepix.gg/dashboard/transactions';
        const headers = {

const msgs_texto = {
    ...
    info: {
        ...
        info:{
            ...
            "*Versão atual* : {p6}\n"+
            "*GitHub* : https://github.com/Kizuno18\n"
        },
        meusdados:{
    ...
    grupo: {
        ...
        bemvindo:{
            ...
            "👉 Entre pra usar o Kizuno18 no Grupo. 👁️"+        
    ...
    admin: {
        entrar_grupo:{
            ...
            link_invalido: "[❗] Isso não é um link válido! \n o Bot não consegue entrar no grupo porque foi removido por um *administrador do grupo*! \n👊🤬",
        ...
        limitediario:{
            ...
            resposta_excedeu_limite: "[❗] {p1} -> Você ultrapassou seu limite diário de comandos por dia (5).\n\n"+
            "para ter *Acesso:*\n_prata, ouro ou VIP_ \nuse *!desbloquear*\nou Use: !tipos\npara saber os tipos.\n🤖 *Kizuno18®* ~"
        },
        limitecomandos:{

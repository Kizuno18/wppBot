...
module.exports = {
    ...
    isOnGroup: async (client, sender, groupId)=>{
    ...
    isVerified: async (sender) => {
        const usuario = await db.usuarios.asyncFindOne({ id_usuario: sender });        
        const isVerified = usuario.tipo !== "bronze";
        return isVerified;
      },      

...
|    (sobre a roletarussa, por favor, lembre de adicionar o membro novamente, pois o bot não fará isso!)
|
╰╼❥ ${process.env.NOME_BOT.trim()}® by *${process.env.NOME_ADMINISTRADOR.trim()}*`
        } else {
            return `__| ☾ *🤖 ${process.env.NOME_BOT.trim()}®* ☽ 
...
|- *!unblock* @usuario  - Desbloqueia o usuário mencionado.

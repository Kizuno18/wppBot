...
module.exports = antiLink = async (client, message) => {
    try{
     ...
     //                     await client.sendTextWithMentions(chatId, criarTexto(msgs_texto.geral.resposta_ban, sender.id.replace("@c.us", ""), msgs_texto.grupo.antilink.motivo, botInfo().nome))
     //                     return false
     //                 }
